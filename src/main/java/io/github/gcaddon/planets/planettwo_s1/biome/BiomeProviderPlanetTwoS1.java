...
public class BiomeProviderPlanetTwoS1 extends BiomeProvider {
	...
	protected BiomeProviderPlanetTwoS1() {
		this.body = AddonPlanets.planetTwoS1;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderPlanetTwoS1(long seed, WorldType type) {
		this();
	...
	public BiomeProviderPlanetTwoS1(World world) {

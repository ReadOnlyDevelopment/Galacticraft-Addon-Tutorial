package io.github.gcaddon.planets.planettwo_s1;
...
public class SkyProviderPlanetTwoS1 extends IRenderHandler {
	
	private static final ResourceLocation sunTexture = new ResourceLocation(ModInfo.ID, "textures/celestialbodies/kepler452b.png");
	...
	public SkyProviderPlanetTwoS1(IGalacticraftWorldProvider mercuryProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderPlanetTwoS1.sunTexture);

...
public class SkyProviderPlanetOneS1 extends IRenderHandler {
	...
	public SkyProviderPlanetOneS1(IGalacticraftWorldProvider mercuryProvider) {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		f10 = this.sunSize;
		mc.renderEngine.bindTexture(SkyProviderPlanetOneS1.sunTexture);

...
import io.github.gcaddon.planets.planetone_s1.biome.gen.GenLayerPlanetOneS1;
...
public class BiomeProviderPlanetOneS1 extends BiomeProvider {
	...
	protected BiomeProviderPlanetOneS1() {
		this.body = AddonPlanets.planetOneS1;
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<>();
	}

	public BiomeProviderPlanetOneS1(long seed, WorldType type) {
		this();
		GenLayer[] genLayers = GenLayerPlanetOneS1.createWorld(seed);
		this.unzoomedBiomes = genLayers[0];
		this.zoomedBiomes = genLayers[1];
	}

	public BiomeProviderPlanetOneS1(World world) {
